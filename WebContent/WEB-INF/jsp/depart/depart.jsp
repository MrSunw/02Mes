        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-default">
			  <div class="panel-heading">
				<h3 class="panel-title"><i class="glyphicon glyphicon-th"></i>部门管理</h3>
			  </div>
...
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='/DispatcherServlet?method=departAddPage'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br>
 <hr style="clear:both;">
	...
	<script src="${pageContext.request.contextPath }/ui/depart/depart.js"></script>
    ...
    var arr = new Array();
    var index = 0;
    <c:forEach items="${DepartList}" var="departnum">
     arr[index++]=${departnum.getDepartNum()}
    </c:forEach>
    //指定图表的配置项和数据
    var option={
    		title:{
    		...
    		xAxis:[{
            	...
            	data:[
            		<c:forEach items="${DepartList}" var="departcode">
