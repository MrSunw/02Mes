...
<html lang="zh-CN">
  ...
  <body>
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="departCode" value="${newdepart.getDepartCode()}">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">部门名称</label>
					<input type="text" class="form-control" id="departName" value="${newdepart.getDepartName()}">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">部门描述</label>
					<input type="text" class="form-control" id="departDesc" value="${newdepart.getDepartDesc()}" >
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">部门人数</label>
					<input type="text" class="form-control" id="departNum" value="${newdepart.getDepartNum()}">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">部门备注</label>
					<input type="email" class="form-control" id="departRemake" value="${newdepart.getDepartRemake()}" >
					<input type="hidden" class="form-control" id="id" value="${newdepart.getId()}"/>
					<input type="hidden" class="form-control" id="pag" value="${pag}"/>
				  </div>
	...
	<script src="${APP_PATH}/ui/depart/edit.js"></script>
  </body>
</html>